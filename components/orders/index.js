  ...
  render() {
    return (
      <div className={styles.container}>
        ...
        {this.state.showProductOrderModal &&  <ProductModalOrder user={this.state.user} show={this.state.showProductOrderModal} closeProductModalOrder={this.closeProductModalOrder}/>}
        ...
        <div className={style.app}>
            ...
            <div style={{borderTop:'1px solid #eaeaea'}} className='row'>
                <div className='col'>
